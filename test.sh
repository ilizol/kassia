...
python3 kassia.py examples/sample.xml examples/sample.pdf
python3 kassia.py examples/sample2.xml examples/sample2.pdf
python3 kassia.py sample3.xml sample3.pdf
